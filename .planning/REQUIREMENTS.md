...
- [x] **FILT-06**: All charts and the entry table update simultaneously when any filter changes

### Charts

- [x] **CHRT-01**: User sees Hours by Client horizontal bar chart
- [x] **CHRT-02**: User sees Hours by Employee horizontal bar chart
- [x] **CHRT-03**: User sees Hours by Topic horizontal bar chart
...
- [x] **TABL-01**: User sees entry table with Date, Employee, Client, Topic, Subtopic, Description, Hours columns
- [x] **TABL-02**: Admin sees Revenue column in the entry table
- [x] **TABL-03**: User can sort and paginate the entry table (50 per page)
...
| FILT-06 | Phase 10 | Complete |
| CHRT-01 | Phase 10 | Complete |
| CHRT-02 | Phase 10 | Complete |
| CHRT-03 | Phase 10 | Complete |
